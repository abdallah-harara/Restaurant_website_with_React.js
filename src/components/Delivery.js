...
import { TbLayoutGridRemove } from './../../node_modules/react-icons/tb/index.esm';
    ...
    <div className='w-full bg-white py-16 px-4'>
      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 '>
        ...
        <div className='flex flex-col justify-center'>
            ...
            <h1 className='md:text-3xl text-2xl font-bold py-2'>Limitless Convenience on-demand</h1>
