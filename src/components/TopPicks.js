...
const TopPicks = () => {
  return (
    <>
      ...
      <div className=' lg:flex   max-w-[1520px] m-auto px-2'>
              ...
              <SplideSlide key={item.id}>
                <div className='rounded-3xl relative'>
                    <div className='absolute w-full h-full bg-black/50 rounded-3xl text-white'>
                      <p className='px-2 pt-4 font-bold sm:text-xl text-2xl'>{item.title}</p>
                       <p className='px-2 pt-0 font-bold  bg-orange-500/30 text-'>{item.price}</p>
